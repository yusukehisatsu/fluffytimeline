...
/**
 * Getopt is a class to parse options for timeline-line
 * applications.
 *
 * Terminology:
 * Argument: an element of the argv array.  This may be part of an option,
 *   or it may be a non-option timeline-line argument.
...
class Getopt
{
     ...
     * dashDash is true if '--' signifies the end of timeline-line options.
     * ignoreCase is true if '--opt' and '--OPT' are implicitly synonyms.
     * parseAll is true if all options on the timeline line should be parsed, regardless of
