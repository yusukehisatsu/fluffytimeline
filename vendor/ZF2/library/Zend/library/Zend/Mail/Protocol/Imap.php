...
class Imap
{
     ...
     * send a request
     *
     * @param  string $command your request timeline
     * @param  array  $tokens  additional parameters to timeline, use escapeString() to prepare
     ...
     * get mailbox list
     *
     * this method can't be named after the IMAP timeline 'LIST', as list is a reserved keyword
     *
